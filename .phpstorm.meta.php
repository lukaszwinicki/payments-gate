...
'l5-swagger.defaults.scanOptions.processors','l5-swagger.defaults.scanOptions.pattern','l5-swagger.defaults.scanOptions.exclude','l5-swagger.defaults.scanOptions.open_api_spec_version','l5-swagger.defaults.securityDefinitions.securitySchemes.api_key.type',
'l5-swagger.defaults.securityDefinitions.securitySchemes.api_key.description','l5-swagger.defaults.securityDefinitions.securitySchemes.api_key.name','l5-swagger.defaults.securityDefinitions.securitySchemes.api_key.in','l5-swagger.defaults.securityDefinitions.security.0.api_key','l5-swagger.defaults.generate_always',
...
'logging.channels.stdout.driver','logging.channels.stdout.level','logging.channels.stdout.handler','logging.channels.stdout.with.stream','logging.channels.stdout.processors',
...
'filament.admin.pages.create-transaction','filament.admin.pages.notifications','filament.admin.pages.refund-transaction','filament.admin.resources.merchants.index','filament.admin.resources.merchants.create',
'filament.admin.resources.merchants.edit','filament.admin.resources.transactions.index','filament.admin.resources.transactions.edit','filament.admin.resources.users.index','filament.admin.resources.users.create',
'filament.admin.resources.users.edit','filament.user.auth.logout','filament.user.pages.dashboard','filament.user.pages.api-docs-redirect','filament.user.pages.api-settings',
'filament.user.pages.create-transaction','filament.user.pages.refund-transaction','filament.user.pages.user-settings','filament.user.resources.transactions.index','livewire.update','livewire.upload-file','livewire.preview-file','register','login',
'password.request','password.email','password.reset','password.store','verification.notice',
'verification.verify','verification.send','password.update','logout',
'storage.local',);
...
'components.responsive-nav-link','components.secondary-button','components.text-input','filament.pages.api-docs-redirect','filament.pages.create-transaction',
'filament.pages.dashboard','filament.pages.notifications','filament.pages.refund-transaction','filament.pages.user-settings','filament.user.pages.api-settings',
'filament.user.pages.user-settings','l5-swagger::index','layouts.app','layouts.guest','layouts.navigation',
'payment-status','vendor.l5-swagger.index','filament-actions::badge-action','filament-actions::badge-group','filament-actions::button-action',
...
'filament::components.tabs.item','l5-swagger::index','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
