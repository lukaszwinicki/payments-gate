    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'tpay-signature-validator' => \App\Services\TPaySignatureValidator::class,
            'transaction-signature-service' => \App\Services\TransactionSignatureService::class,
    ...
    override(\config(), map([
            ...
            'app.providers' => 'array',
            'app.aliases.TPaySignatureValidator' => 'string',
            'app.tpay.openApiUrl' => 'string',
            'app.tpay.gateway' => 'string',
            'app.tpay.tokenClientId' => 'string',
            'app.tpay.tokenClientSecret' => 'string',
            'app.paynow.sandboxApiUrl' => 'string',
            'app.paynow.apiKey' => 'string',
            'app.paynow.signatureKey' => 'string',
            'app.noda.sandboxApiUrl' => 'string',
            'app.noda.apiKey' => 'string',
            'app.noda.signetureKey' => 'string',
            'app.noda.notificationUrl' => 'string',
            'app.api_docs_url' => 'string',
            'app.returnUrl' => 'string',
            'app.frontendUrl' => 'string',
            'app.paymentsGatewayBaseUrl' => 'string',
            ...
            'l5-swagger.defaults.securityDefinitions.securitySchemes.api_key.type' => 'string',
            'l5-swagger.defaults.securityDefinitions.securitySchemes.api_key.description' => 'string',
            'l5-swagger.defaults.securityDefinitions.securitySchemes.api_key.name' => 'string',
            'l5-swagger.defaults.securityDefinitions.securitySchemes.api_key.in' => 'string',
            'l5-swagger.defaults.securityDefinitions.security.0.api_key' => 'array',
            ...
            'logging.channels.stdout.driver' => 'string',
            'logging.channels.stdout.level' => 'string',
            'logging.channels.stdout.handler' => 'string',
            'logging.channels.stdout.with.stream' => 'string',
            'logging.channels.stdout.processors' => 'array',
            'mail.default' => 'string',
...
'app.providers','app.aliases.TPaySignatureValidator','app.tpay.openApiUrl','app.tpay.gateway','app.tpay.tokenClientId',
'app.tpay.tokenClientSecret','app.paynow.sandboxApiUrl','app.paynow.apiKey','app.paynow.signatureKey','app.noda.sandboxApiUrl',
'app.noda.apiKey','app.noda.signetureKey','app.noda.notificationUrl','app.api_docs_url','app.returnUrl',
'app.frontendUrl','app.paymentsGatewayBaseUrl','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./var/www/public/storage','l5-swagger.default',
...
'l5-swagger.defaults.scanOptions.open_api_spec_version','l5-swagger.defaults.securityDefinitions.securitySchemes.api_key.type','l5-swagger.defaults.securityDefinitions.securitySchemes.api_key.description','l5-swagger.defaults.securityDefinitions.securitySchemes.api_key.name','l5-swagger.defaults.securityDefinitions.securitySchemes.api_key.in',
'l5-swagger.defaults.securityDefinitions.security.0.api_key','l5-swagger.defaults.generate_always','l5-swagger.defaults.generate_yaml_copy','l5-swagger.defaults.proxy','l5-swagger.defaults.additional_config_url',
...
'logging.channels.null.handler','logging.channels.emergency.path','logging.channels.stdout.driver','logging.channels.stdout.level','logging.channels.stdout.handler',
'logging.channels.stdout.with.stream','logging.channels.stdout.processors','mail.default','mail.mailers.smtp.transport','mail.mailers.smtp.scheme',
...
'hashing.rehash_on_login','concurrency.default','blade-heroicons.prefix','blade-heroicons.fallback','blade-heroicons.class',
...
'signed','throttle','verified','api-key',);
...
'filament.imports.failed-rows.download','filament.admin.auth.logout','filament.admin.pages.dashboard','filament.admin.pages.api-docs-redirect','filament.admin.pages.api-settings',
'filament.admin.pages.create-payment-link','filament.admin.pages.create-transaction','filament.admin.pages.notifications','filament.admin.pages.refund-transaction','filament.admin.resources.merchants.index',
'filament.admin.resources.merchants.create','filament.admin.resources.merchants.edit','filament.admin.resources.transactions.index','filament.admin.resources.transactions.edit','filament.admin.resources.users.index',
'filament.admin.resources.users.create','filament.admin.resources.users.edit','filament.user.auth.logout','filament.user.pages.dashboard','filament.user.pages.api-docs-redirect',
'filament.user.pages.api-settings','filament.user.pages.create-transaction','filament.user.pages.refund-transaction','filament.user.pages.user-settings','filament.user.resources.transactions.index',
'livewire.update','livewire.upload-file','livewire.preview-file','register','login','password.request','password.email',
...
'components.responsive-nav-link','components.secondary-button','components.text-input','filament.pages.api-docs-redirect','filament.pages.create-payment-link',
'filament.pages.create-transaction','filament.pages.dashboard','filament.pages.notifications','filament.pages.refund-transaction','filament.pages.user-settings',
'filament.user.pages.api-settings','filament.user.pages.user-settings','l5-swagger::index','layouts.app','layouts.guest',
'layouts.navigation','payment-status','vendor.l5-swagger.index','filament-actions::badge-action','filament-actions::badge-group',
...
'filament::components.tabs.index','filament::components.tabs.item','l5-swagger::index','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','TPAY_OPEN_API_URL',
'TPAY_GATEWAY','TPAY_TOKEN_CLIENT_ID','TPAY_TOKEN_CLIENT_SECRET','PAYNOW_SANDBOX_API_URL','PAYNOW_API_KEY',
'PAYNOW_SIGNATURE_KEY','NODA_SANDBOX_API_URL','NODA_API_KEY','NODA_SIGNATURE_KEY','NODA_WEBHOOK_URL',
'API_DOCS_URL','RETURN_URL','FRONTEND_URL','PAYMENTS_GATEWAY_BASE_URL',);
