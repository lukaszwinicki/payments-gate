...
'app.tpay.tokenClientSecret','app.signatureSecretKey','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver',
...
'TPAY_GATEWAY','TPAY_TOKEN_CLIENT_ID','TPAY_TOKEN_CLIENT_SECRET','SIGNATURE_SECRET_KEY',);
